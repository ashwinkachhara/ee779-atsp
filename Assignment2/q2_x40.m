...
title('x40 Power spectral estimate: AR autocorrelation method')
ylabel('dB')
xlabel('n(1:1024)')
...
title('x40 Power spectral estimate: AR covariance method')
ylabel('dB')
xlabel('n(1:1024)')
%% b)iii) MUSIC method
...
title('x40 Power spectral estimate: MUSIC')
ylabel('dB')
xlabel('n(1:1024)')
...
title('x40 Power spectral estimate: Min-norm')
ylabel('dB')
xlabel('n(1:1024)')
%%
figure(6)
...
%%
% The AR covariance method: As the error magnitude increases, the accuracy
% of the estimate decreases. Middle peak is barely visible now
%%
...
% performed in MUSIC, eradicates the spurious peaks. The peaks become more
% wideband as the noise amplitude increases.
%%
...
% generally not that prominent. The peaks become more
% wideband as the noise amplitude increases.
