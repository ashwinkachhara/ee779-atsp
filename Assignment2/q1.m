...
% Since it is mentioned to use the best case periodogram, we will use the
% Blackman-Tukey periodogram for the same.
%%
% Using Rectangular Window of length 32
%%
per1 = btse(S, rectwin(32), 512);
figure(3)
plot(per1)
%%
% Using Hamming Window of length 32
%%
per2 = btse(S, hamming(32), 512);
figure(4)
plot(per2)
%%
