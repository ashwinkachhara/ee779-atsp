%% EE779 Computing Assignment 2 Q2 (K10)
...
title('x10 Power spectral estimate: AR autocorrelation method')
ylabel('dB')
xlabel('n(1:1024)')
...
title('x10 Power spectral estimate: AR covariance method')
ylabel('dB')
xlabel('n(1:1024)')
%% b)iii) MUSIC method
...
title('x10 Power spectral estimate: MUSIC')
ylabel('dB')
xlabel('n(1:1024)')
...
title('x10 Power spectral estimate: Min-norm')
ylabel('dB')
xlabel('n(1:1024)')
%%
figure(6)
...
title('x10 Power spectral estimates')
ylabel('dB')
xlabel('n(1:1024)')
%%
...
% peaks nearabout the correct value. Two of the main peaks are slightly 
% askew compared to the MUSIC and min-norm. Also, the middle peak is lower
% than its counter parts in MUSIC and min-norm.
% There are some smaller peaks along the spectrum, but their amplitude is 
% much less than the main peaks
%%
